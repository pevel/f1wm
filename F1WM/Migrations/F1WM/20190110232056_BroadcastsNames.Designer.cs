...
namespace F1WM.Migrations.F1WM
{
	...
	[Migration("20190110232056_BroadcastsNames")]
	partial class BroadcastsNames
	{
...
#pragma warning disable 612, 618
			...
			modelBuilder.Entity("F1WM.DatabaseModel.BroadcastedSession", b =>
				{
					...
					b.Property<int>("BroadcastedSessionNameId");
					...
					b.HasIndex("BroadcastedSessionNameId");
			...
			modelBuilder.Entity("F1WM.DatabaseModel.BroadcastedSessionName", b =>
				{
					b.Property<int>("Id")
						.ValueGeneratedOnAdd();
					...
					b.ToTable("BroadcastedSessionNames");
				});
			...
			modelBuilder.Entity("F1WM.DatabaseModel.BroadcastedSession", b =>
				{
					b.HasOne("F1WM.DatabaseModel.BroadcastedSessionName", "Name")
						.WithMany()
						.HasForeignKey("BroadcastedSessionNameId")
						.OnDelete(DeleteBehavior.Cascade);
