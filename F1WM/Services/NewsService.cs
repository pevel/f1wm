...
namespace F1WM.Services
{
	public class NewsService : INewsService
	{
		...
		public Task<NewsSummaryPaged> GetLatestNews(int? firstId, uint page, uint countPerPage)
		{
		...
		public Task<NewsSummaryPaged> GetNewsByTagId(int id, uint page, uint countPerPage)
		{
			return newsRepository.GetNewsByTagId(id, page, countPerPage);
		}

		public Task<NewsSummaryPaged> GetNewsByTypeId(int id, uint page, uint countPerPage)
		{
		...
		public Task<NewsTagsPaged> GetNewsTags(uint page, uint countPerPage)
		{
			return newsRepository.GetNewsTags(page, countPerPage);
		}

		public Task<NewsTagsPaged> GetNewsTagsByCategoryId(int id, uint page, uint countPerPage)
		{
